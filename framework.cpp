...
void Framework::CompileShaders()
{
	...
	rootParam.Constants.Num32BitValues = 16; // viewProj 행렬
	...
	D3D12_INPUT_ELEMENT_DESC layout[] = {
		...
		// Slot 1: 인스턴스 데이터 — 월드 행렬 4행 + 색상 (PER_INSTANCE, stride=sizeof(InstanceData))
